  ...
  return (
    <Layout>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Your Jobs Tab - Messages and Conversations */}
        {activeTab === "your-jobs" && (
                          ...
                          <div key={message.id} className={`flex ${isOwn ? "justify-end" : "justify-start"}`}>
                            <div
                              className={`max-w-xs px-4 py-2 rounded-lg ${
                                isOwn ? "bg-[#24405A] text-white" : "bg-slate-100 text-slate-900"
                              }`}
                            >
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 relative">
                        ...
                        <input
                          ...
                          id="file-input"
                        />
                        <label htmlFor="file-input" className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-slate-400 hover:text-slate-600">
